...
A simple, flexible and powerful logging utility for PHP applications. This project offers three versions with increasingly improved features and ease of use.
...
-   **Multiple versions**: Three different versions with progressive improvements
...
2. Include the desired version in your PHP project:
    ```php
    require_once 'path/to/vX/log.php'; // where X is the version number (1, 2, or 3)
    ```
...
The most streamlined version with function-like usage.
